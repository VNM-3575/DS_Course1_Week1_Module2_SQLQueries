...
# Sort result alphabetically by breed
...
# ### Step 12
#
# For each team that Babe Ruth played on and averaged over 200 at bats with, return the team name and average number of at bats, aliased as 'average_at_bats'.
#
